...
//    private OnInsetsCallback mOnInsetsCallback;
    ...
    public CustomScrimInsetsFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public CustomScrimInsetsFrameLayout(Context context, AttributeSet attrs, int defStyle) {
