 ...
 *    (i.e. in the [MainViewModel]), and therefore in other portions of the app, come immediately
...
class BillingRepository private constructor(private val application: Application) :
     ...
     * what's for sale. gasTankLiveData, premiumLiveData, and goldStatusLiveData will tell the
    ...
    /**
     * Tracks whether this user is entitled to premium access. This call returns data from the app's
    ...
    val premiumLiveData: LiveData<Premium> by lazy {
        ...
        localCacheBillingClient.entitlementsDao().getPremium()
    }
