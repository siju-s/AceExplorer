...
//
//    SearchHelper(MenuControls menuControls, Context context, View actionBar) {
//        this.context = context;
//        this.menuControls = menuControls;
//        init(actionBar);
//    }
//
//    private void init(View actionBar) {
//        searchView = actionBar.findViewById(R.id.search_view);
...
//        if (isExpanded) {
//            menuControls.onSearchExpanded();
//            searchView.setHint(getString(R.string.action_search));
//        }
//        else {
//            menuControls.onSearchClosed();
//        }
//    }
//
